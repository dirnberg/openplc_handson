...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  __INIT_VAR(data__->COUNTER,0,retain)
  __INIT_VAR(data__->RED,0,retain)
  __INIT_VAR(data__->TL_STATE,0,retain)
  __INIT_VAR(data__->YELLOW,0,retain)
  __INIT_VAR(data__->GREEN,0,retain)
}
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  {
    UINT __case_expression = __GET_VAR(data__->TL_STATE,);
    if ((__case_expression == 0)) {
      __SET_VAR(data__->,RED,,__BOOL_LITERAL(TRUE));
      __SET_VAR(data__->,YELLOW,,__BOOL_LITERAL(FALSE));
      __SET_VAR(data__->,GREEN,,__BOOL_LITERAL(FALSE));
    }
    else if ((__case_expression == 1)) {
      __SET_VAR(data__->,RED,,__BOOL_LITERAL(FALSE));
      __SET_VAR(data__->,YELLOW,,__BOOL_LITERAL(TRUE));
      __SET_VAR(data__->,GREEN,,__BOOL_LITERAL(FALSE));
    }
    else if ((__case_expression == 2)) {
      __SET_VAR(data__->,RED,,__BOOL_LITERAL(FALSE));
      __SET_VAR(data__->,YELLOW,,__BOOL_LITERAL(FALSE));
      __SET_VAR(data__->,GREEN,,__BOOL_LITERAL(TRUE));
    }
  ...
  __SET_VAR(data__->,TL_STATE,,DIV__UINT__UINT__UINT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)__GET_VAR(data__->COUNTER,),
    (UINT)60));
  __SET_VAR(data__->,COUNTER,,ADD__UINT__UINT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (UINT)1,
